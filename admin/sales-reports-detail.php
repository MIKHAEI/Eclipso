...
<html>
<head>
<title>ODRS || Sales Reports</title>
...
<?php
$ret=mysqli_query($con,"select month(PaymentDate) as lmonth,year(PaymentDate) as lyear,sum(AmountPay) as totalprice from  tblinvoice where date(tblinvoice.PaymentDate) between '$fdate' and '$tdate' group by lmonth,lyear");
$cnt=1;
...
$ret=mysqli_query($con,"select year(PaymentDate) as lyear,sum(AmountPay) as totalprice from  tblinvoice where date(tblinvoice.PaymentDate) between '$fdate' and '$tdate' group by lyear");
